...
function ToolBar ({user_role}) {
  ...
  useEffect(() => {
    // add the current page class to the current page
    if (location.pathname.includes('settings')) {
      setCurrentPage([settingsRef.current]);
      settingsRef.current.classList.add('current-page');
    } 
  ...
  return (
    <div className="tool-bar">
      ...
      <div className="navigation">
        ...
        {user_role === "teacher" && <button className="curriculum-button" onClick={handleCurriculumClick} ref={curriculumRef}>
            <svg xmlns="http://www.w3.org/2000/svg" height="23" width="23" viewBox="0 0 512 512">
            {/* Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc */}
        ...
        <button className="settings-button" onClick={handleSettingsClick} ref={settingsRef}>
            <svg xmlns="http://www.w3.org/2000/svg" height="23" width="23" viewBox="0 0 512 512">
            {/* Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc */}
